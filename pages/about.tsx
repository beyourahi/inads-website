...
const About: NextPage = () => (
    <Layout page="About">
        {/*//! Hero */}
        <div className="bg-[url('/writing.png')] bg-cover pb-36 pt-52">
                ...
                <div className="flex bg-black space-x-32">
                    ...
                    <div className="space-y-16 w-[55%]">
                        ...
                        <p className="text-2xl break-all">
                            ...
                            Qatar. A complete solutions provider for their advertisers with multiple
                            eﬃciencies, including strategic planning, buying clout, social media
                            muscle, content development, mobile media versatility and more planning
                            process to gain a deep understanding of the client&apos;s brand and
                            message, what they want to achieve and how to achieve the optimum
                            results in the right set of media channels.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex bg-black space-x-32">
                    <div className="space-y-16 w-[55%]">
                        <p className="text-2xl break-all">
                            ...
                            communications plan which connects with the client&apos;s target
                            audience.
                            <br />
                            <br />
                            We craft the message that needs to be heard, and determine how and where
                            it should be heard, from traditional advertising to out-of-home media to
                            online display and search ads.
                            <br />
                            <br />
                            We pride ourselves on our outstanding client service and we won&apos;t
                            settle for anything less than perfect for our clients and consider all
                            their media options, then design a marketing plan that meets their
                            goals.
                        </p>
                    </div>
        ...
        <div className="flex bg-black">
            <div className="space-y-16 p-28 w-[55%]">
                ...
                <p className="text-2xl break-all">
                    ...
                    brands and reaching out to a large range of potential customers all over Qatar.
                </p>
            </div>
