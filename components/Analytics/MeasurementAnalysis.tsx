            ...
            <div className="flex relative">
                ...
                <div className="w-[60%] space-y-8">
                    <div className="flex items-center space-x-9">
                        ...
                        <h1 className="text-2xl w-[50%]">Design study to measure campaign goals</h1>
                    </div>

                    <div className="flex items-center space-x-9">
                        <h1 className="text-primary text-3xl font-medium">Step 2</h1>
                        <div>
                            <Image src={divider} alt="Divider" className="object-contain" />
                        </div>
                        <h1 className="text-2xl w-[50%]">Activate campaign</h1>
                    </div>

                    <div className="flex items-center space-x-9">
                        <h1 className="text-primary text-3xl font-medium">Step 3</h1>
                        <div>
                            <Image src={divider} alt="Divider" className="object-contain" />
                        </div>
                    ...
                    <div className="flex items-center space-x-9">
                        <h1 className="text-primary text-3xl font-medium">Step 4</h1>
                        <div>
                            <Image src={divider} alt="Divider" className="object-contain" />
                        </div>
                        <h1 className="text-2xl w-[50%]">
                    ...
                    <div className="flex items-center space-x-9">
                        <h1 className="text-primary text-3xl font-medium">Step 5</h1>
                        <div>
                            <Image src={divider} alt="Divider" className="object-contain" />
                        </div>
                        <h1 className="text-2xl w-[50%]">
