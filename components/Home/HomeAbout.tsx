...
export const HomeAbout: React.FC = () => (
    ...
    >
        ...
        <div className="container mx-auto px-5 xl:px-36 flex flex-col lg:flex-row items-center lg:space-x-12 xl:space-x-28 space-y-24 lg:space-y-0">
            ...
            <div className="w-full lg:w-[50%] flex flex-col items-center space-y-12 xl:items-start">
                ...
                <p className="font-ps font-normal text-lg text-center xl:text-left">
