...
export const Footer: React.FC = () => (
    <footer className="bg-black text-white container mx-auto px-36 divide-y-[1px] divide-white/25">
        {/*//! Top */}
        <div className="flex justify-between py-24">
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col space-y-2">
                    {nav_links.map(link => (
                        <span key={link.name} className="hover:text-primary transition-all ease-in">
